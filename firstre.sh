...
test=(dev.wanleyun.com)
production=(dev.wanleyun.com)
staticurl="http://online.static.dev.wanleyun.com/"
static_host="static.dev.wanleyun.com"
server_host="dev.wanleyun.com"
server_path="/data/www/dev.wanleyun.com/static/dist"
